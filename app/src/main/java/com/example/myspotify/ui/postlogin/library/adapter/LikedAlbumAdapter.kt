...
class LikedAlbumAdapter(private val onClickListener: OnClickListener) : ListAdapter<Album, LikedAlbumAdapter.LikedAlbumViewHolder>(DiffCallback) {

    inner class LikedAlbumViewHolder(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LikedAlbumViewHolder {
        return LikedAlbumViewHolder(
            PopularReleaseItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }

    override fun onBindViewHolder(holder: LikedAlbumViewHolder, position: Int) {
